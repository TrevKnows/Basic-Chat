...
//Finding the main function for the peripheral view controller
   //Add string text to basetextview
    //clear data in base text view once vuew controller is not in scene.
    //For the base text view -> create an array that holds all outgoing and a seperate incoming text.
    //Convert attributed String to NSString
    //Display within TextView
